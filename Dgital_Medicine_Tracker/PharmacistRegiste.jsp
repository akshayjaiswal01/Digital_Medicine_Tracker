...
<%
  ...
  <div class="container">
    ...
    <form  action="CreatePharmacistAccount" method="post">
      <div class="form-group">
        <input type="text" id="id" name="phid" required>
        <label for="phid">ID</label>
      </div>
      <div class="form-group">
        <input type="text" id="name" name="phname" required>
        <label for="phname">Name</label>
      </div>
      <div class="form-group">
        <input type="email" id="email" name="phemail" required>
        <label for="phemail">Email</label>
      </div>
      <div class="form-group">
        <input type="text" id="shopName" name="ph_store_name" required>
        <label for="ph_store_name">Shop Name</label>
      </div>
      <div class="form-group">
        <input type="tel" id="mobile" name="phmob" required>
        <label for="phmob">Mobile Number</label>
      </div>
      <div class="form-group">
        <input type="text" id="address" name="phaddress" required>
        <label for="phaddress">Address</label>
      </div>
      <div class="form-group">
        <input type="password" id="password" name="phpassword" required>
    ...
    <div class="login-links">
      ...
      <a class="small-button" href="http://localhost:8080/FreeShop/PharmacisLogin.html">Pharmacist Login</a>
    </div>
  </div>
</body>
</html>
